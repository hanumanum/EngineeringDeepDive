...
export function linkedListSimpleTests() {
    ...
    ll.push(5)
    ll.push(4)
    console.log("test", ll.toString() === "2,5,4")
    console.log("test size", ll.getSize() === 3)

    ll.insert(1, 1000)
    console.log("test", ll.toString() === "2,1000,5,4")
    console.log("test size", ll.getSize() === 4)

    ll.insert(15, 2000)
    console.log("test", ll.toString() === "2,1000,5,4,2000")
    ...
    ll.insert(0, 58999)
    console.log("test", ll.toString() === "58999,2,1000,5,4,2000")
    console.log("test size", ll.getSize() === 6)
    
    ll.insert(0, 589990)
    console.log("test", ll.toString() === "589990,58999,2,1000,5,4,2000")
    console.log("test size", ll.getSize() === 7)

    ll.erase(1)
    console.log("test", ll.toString() === "589990,2,1000,5,4,2000")
    console.log("test size", ll.getSize() === 6)

    ll.erase(5)
    console.log("test", ll.toString() === "589990,2,1000,5,4")
    console.log("test size", ll.getSize() === 5)
    ...
    ll.erase(3)
    console.log("test", ll.toString() === "2,1000,5")
    console.log("test size", ll.getSize() === 3)
    ...
    ll.erase(2)
    console.log("test", ll.toString() === "2,1000")
    console.log("test size", ll.getSize() === 2)

    ll.clear()
    console.log("test", ll.toString() === "")
